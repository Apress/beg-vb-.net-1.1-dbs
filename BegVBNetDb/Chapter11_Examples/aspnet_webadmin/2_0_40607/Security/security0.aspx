...
public void RedirectToChooseProvider(object s, EventArgs e) {
    PopPrevRequestUrl();
...
<asp:button runat="server" id="button1" onClick="RedirectToChooseProvider" text="<%$ Resources: ChooseDataStore %>"/>
</asp:content>

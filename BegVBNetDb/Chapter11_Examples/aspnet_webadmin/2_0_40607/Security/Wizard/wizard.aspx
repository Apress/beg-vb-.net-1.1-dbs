...
private void ActiveViewChanged(object s, EventArgs e) {
    UpdateControls();
}
...
public void NavigationTreeNodeChanged(object s, EventArgs e) {
    TreeView tv = (TreeView) s;
...
private void PrevStep(object s, EventArgs e) {
...
<form runat="server">
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" >
        <tr>
            <td class="appHeader" colspan="2" height="70" valign="top"><img src="../../images/ASPdotNET_logo.jpg" width="198" height="46" alt="ASP.NET Logo" border="0">
                <span class="logoText">
        ...
        <tr>
            <td height="35" class="callOutHeaderStyle" colspan="2" valign="center" align="left"><asp:literal runat="server" text="<%$ Resources: SecuritySetupWizard %>"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td valign="bottom">
                <table align="right" valign="bottom" width="" height="" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td><img src="../../images/yellowCorner.gif" width="34" height="29" alt="" border="0"/></td>

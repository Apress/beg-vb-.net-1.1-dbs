...
public void Page_Load() {
    ...
    if(!IsPostBack) {
        ...
        Int32 total;
        dataGrid.DataSource = MembershipHelperInstance.GetAllUsers(0, Int32.MaxValue, out total);
...
public void SelectedChanged(object s, EventArgs e) {
...
public void SearchForUsers(object s, EventArgs e) {
    SearchForUsers(s, e, alphabetRepeater, dataGrid, dropDown1, textBox1);
    SetDataSource(dataGrid.DataSource);
    BindGrid();
}
</script>

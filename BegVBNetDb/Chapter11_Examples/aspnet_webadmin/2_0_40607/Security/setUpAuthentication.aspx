...
public void UpdateAndReturnToPreviousPage(object s, EventArgs e) {
    Configuration config = GetWebConfiguration(ApplicationPath);
    AuthenticationSection auth = (AuthenticationSection) config.GetSection("system.web/authentication");
...
<asp:content runat="server" contentplaceholderid="buttons">
    <asp:button  runat="server" id="button1" text="<%$ Resources:DoneButton %>" onclick="UpdateAndReturnToPreviousPage"/>
</asp:content>

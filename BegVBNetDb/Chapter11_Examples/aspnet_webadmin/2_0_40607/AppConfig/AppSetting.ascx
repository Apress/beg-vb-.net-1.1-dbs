        ...
        <td>
            <table class="bodyText" cellpadding="4">
                <tr>
                    ...
                    <td><asp:TextBox runat=server id="NameTextBox" maxLength="256" width="155"/>&nbsp;<input type="text" style="visibility:hidden;width:0px;" /></td>
                </tr>
                <tr>
                    <td><asp:Label runat="server" AssociatedControlID="ValueTextBox" Text="<%$ Resources:ValueLabel %>" /></td>
                    <td><asp:TextBox runat=server id="ValueTextBox" maxLength="256" width="155"/></td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table height="100%" width="100%">
                <tr>
                    <td class="bodyText">
                        ...
                        <asp:RequiredFieldValidator runat="server" EnableClientScript="false" ControlToValidate="NameTextBox"

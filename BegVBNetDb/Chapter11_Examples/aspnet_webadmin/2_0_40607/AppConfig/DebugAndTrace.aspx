...
private void Page_Load() {
    if (!IsPostBack) {
        ...
        SortTraceList.SelectedIndex = (traceSection.Mode == TraceDisplayMode.SortByCategory) ? 1 : 0;

        bool mostRecent = traceSection.MostRecent;
        MostRecentTracesList.SelectedIndex = (mostRecent) ? 0 : 1;
...
private void WebControl_ValueChanged(object s, EventArgs e) {
    ...
    switch (control.ID) {
        ...
        case "EnableTraceCheckBox":
            ...
            break;
        case "SortTraceList":
            traceSection.Mode = (SortTraceList.SelectedIndex == 0) ? TraceDisplayMode.SortByTime : TraceDisplayMode.SortByCategory;
            break;
        ...
        default:
            throw new HttpException("Encountered invalid ID: " + control.ID);
    }
